...
class TestL4PolicyBuilder:
    ...
    def test_build_l4_policies_consolidation(self, mock_is_ipv4, mock_port_func):
        ...
        # Mock function should be called with the list of ports
        mock_port_func.assert_called_with(['80', '443'])
...
class TestInternetPolicyBuilder:
    ...
    def test_build_internet_policies_empty_input(self):
        ...
        empty_df = pd.DataFrame()
        result_df = builder.build_internet_policies(empty_df, empty_df, empty_df)
