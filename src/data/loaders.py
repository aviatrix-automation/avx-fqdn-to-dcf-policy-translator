...
class TerraformLoader:
    ...
    def load_tf_resource(self, resource_name: str) -> pd.DataFrame:
        ...
        try:
            ...
            try:
                with open(sanitized_file_path, 'r') as fp:
    ...
    def load_all_terraform_resources(self) -> Dict[str, pd.DataFrame]:
        ...
        resource_names = [
            'firewall_tag', 'firewall_policy', 'firewall',
            'fqdn_tag_rule', 'fqdn', 'smart_group'
        ]
    ...
    def load_gateway_details(self) -> pd.DataFrame:
        ...
        try:
            ...
            if 'results' not in gateway_details:
                self.logger.error(f"Invalid gateway details format - missing 'results' key")
                return pd.DataFrame()
